...
#define    OSS_COMPILER_API_LEVEL 34
...
void DLL_ENTRY _jeKerberosV5Spec2(OssGlobal * _g, int _pdunum, void * _inbuf);
void * DLL_ENTRY _jdKerberosV5Spec2(OssGlobal * _g, int _pdunum);
#endif
...
void DLL_ENTRY_FDEF _ossinit_kull_m_kerberos_asn1(struct ossGlobal *world) {
    ...
    ossPrivateSetMoreFlags(world, 15, _privateFlags);
    ossLinkBer(world);
    if (world) {
...
#endif
#if OSS_TOED_API_LEVEL >= 34
void DLL_ENTRY_FDEF _jeKerberosV5Spec2(OssGlobal * _g, int _pdunum, void * _inbuf)
{
...
void * DLL_ENTRY_FDEF _jdKerberosV5Spec2(OssGlobal * _g, int _pdunum)
{
    _oss_toed_error(_g, _unlinked_encrules_err, "JSON");
    _pdunum = _pdunum;	/* to avoid C-compilation warning */
    return NULL;
...
static void _oss_post_init(struct ossGlobal *world) {
    static const unsigned char _oss_typeinfo[] = {
        0x00, 0x5f, 0x34, 0x39, 0xf8, 0x5e, 0x13, 0xa4, 0x1a, 0x18,
        0x3b, 0xa6, 0x1a, 0x1b, 0x3b, 0xbb, 0xd2, 0x20, 0xf6, 0xa4,
        0xe3, 0xec, 0xa2, 0xb6, 0x11, 0xe1, 0xec, 0x15, 0x43, 0xb8,
        0x95, 0x38, 0x13, 0x9b, 0x59, 0x9e, 0xd3, 0x62, 0xc8, 0x0d,
        0xae, 0xa5, 0x9b, 0x4d, 0x49, 0x4c, 0x71, 0xad, 0xcf, 0x6f,
        0xf6, 0xb6, 0xcf, 0x52, 0x95, 0xea, 0x79, 0x2e, 0x46, 0xe4,
        0x32, 0x1a, 0x07, 0x44, 0xec, 0x4e, 0x0e, 0x9b, 0x52, 0xd1,
        0x54, 0xbe, 0xb9, 0x72, 0x89, 0xa3, 0x0a, 0x22, 0xa3, 0x69,
        0xae, 0xe4, 0xfb, 0x55, 0xef, 0x37, 0xe3, 0xb3, 0x4f, 0x49,
        0xd5, 0x72, 0xad, 0x84, 0x59, 0x4b, 0xb7
    };
