...
#define MIMIKATZ_FULL			MIMIKATZ " " MIMIKATZ_VERSION " (" MIMIKATZ_ARCH ") built on " __DATE__ " " __TIME__
...
#ifndef PRINT_ERROR
#define PRINT_ERROR(...) (kprintf("ERROR " __FUNCTION__ " ; " __VA_ARGS__))
#endif

#ifndef PRINT_ERROR_AUTO
#define PRINT_ERROR_AUTO(func) (kprintf("ERROR " __FUNCTION__ " ; " func " (0x%08x)\n", GetLastError()))
#endif

#ifndef W00T
#define W00T(...) (kprintf(__FUNCTION__ " w00t! ; " __VA_ARGS__))
#endif
