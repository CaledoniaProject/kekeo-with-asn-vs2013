...
/*****************************************************************************/
/* FILE: @(#)osstype.hh	17.41  16/04/17                                      */
/*****************************************************************************/
...
typedef struct ossDebugData {
    ...
    void (DLL_ENTRY_FPTR *_System oss_print_json_ptr)(struct ossGlobal *,
					    char *, long, ossBoolean);
} ossDebugData;
#endif /* _OSS_CODE_FILE ... */
...
enum _err_index {
/*
 * FILE: @(#)coderror.h	17.14  16/02/04
 */
...
PUBLIC void DLL_ENTRY ossLinkJsonE(struct ossGlobal *);
PUBLIC void DLL_ENTRY ossLinkJsonD(struct ossGlobal *);
...
typedef struct {
    OSS_UINT32 _oss_JW;
    void *_oss_wWW;		
    unsigned char *_oss_HqJ;	
    OSS_UINT16 _oss_WQW;		
    OSS_UINT16 _oss_qwW;	
} exer_tag_decoder;
typedef struct {
    OSS_UINT32 _oss_JW;
    exer_tag_decoder *_oss_qQW;
    OSS_UINT32 _oss_wJW;		
} exer_decode_position;
typedef struct {
    unsigned char *_oss_Hq;
    OSS_UINT16 _oss_Jq;
} exer_uri_test;
typedef struct {
    exer_search _oss_JJJ;		
    exer_uri_test *_oss_WwJ;	
} exer_qname_table;
typedef struct {
    unsigned char *_oss_Hq;
    OSS_UINT16 _oss_Wq;
...
typedef struct {
    OSS_UINT32		_oss_JW;
    exer_enum_data	*_oss_Jw;
    exer_enum_value 	*_oss_jqJ;
} exer_enum;
typedef struct {
    OSS_UINT32		_oss_JW;
    exer_enum_data	*_oss_Jw;
    unsigned long	_oss_HwJ;
...
typedef struct st_OssEmbedData _oss_jjJ;
...
typedef struct exer_qname {
    ...
    unsigned int	_oss_wWH;
    OSS_UINT16        	_oss_wQj;	
} exer_qname;
#if 0
typedef struct _exer_ns {
    struct _exer_ns	*_oss_JWH;
    struct _exer_ns	*_oss_jww;
    unsigned char	*_oss_wQH;
    unsigned char	*_oss_WjW;
    unsigned long	_oss_QQw;
    unsigned long	_oss_wWH;
} _exer_ns;
#endif
typedef struct exer_uri_list exer_uri_list;
typedef struct exer_attr_list exer_attr_list;
struct exer_attr_list {
    exer_attr_list	*_oss_JWH;
    unsigned char	*_oss_wQH;
    unsigned char	*_oss_WjW;
    unsigned int	_oss_QQw;
    unsigned int	_oss_wWH;
};
struct exer_eenv;
...
typedef    void *     (DLL_ENTRY_FPTR *_System _Decode_JSON_function)
			(struct ossGlobal *world, int pduNum);
...
/* JSON tokens */
#define JS_NONE			0x0000
#define JS_UNKNOWN		0x0001
#define JS_BEGIN_OBJECT		0x0002   /* '{' */
#define JS_END_OBJECT		0x0004   /* '}' */
#define JS_BEGIN_ARRAY		0x0008   /* '[' */
#define JS_END_ARRAY		0x0010   /* ']' */
#define JS_COMMA		0x0020   /* ',' */
#define JS_COLON		0x0040   /* ':' */
#define JS_STRING		0x0080   /* "..." */
#define JS_NUMBER		0x0100   /* [-]12345.67E+10 */
#define JS_TRUE			0x0200   /* 'true' */
#define JS_FALSE		0x0400   /* 'false' */
#define JS_NULL			0x0800   /* 'null' */
#define JS_END			0x1000   /* End of encoding */
#define JS_ALL    		(JS_BEGIN_OBJECT | JS_BEGIN_ARRAY | JS_STRING \
				| JS_NUMBER | JS_TRUE | JS_FALSE | JS_NULL)
...
/* For additional flags-related information */
    ...
    ToedExerData exd;
    char	*ext_errMsg;
    void (DLL_ENTRY_FPTR *_System _oss_db_e_post_ptr)(struct ossGlobal *,
					    int, char *, long);
    void (DLL_ENTRY_FPTR *_System _oss_db_d_post_ptr)(struct ossGlobal *,
					    int, int, void **);
    void        *cppCallbackObj;
...
#define _oss_ps_t_time_fraction(g) \
	(_oss_get_1bit_unaligned(g) ? _oss_pskip_int(g) \
			    : (_oss_c->_aligned ? _oss_skip_bits(g, 16, Aligned) \
					: _oss_skip_bits(g, 10U, Unaligned)))
#define _oss_ps_t_day_of_year(g) \
	((_oss_c->_aligned) ? _oss_skip_bits(g, 16, Aligned) \
			    : _oss_skip_bits(g, 9U, Unaligned))
...
#if defined(OSS_TOED_XER) || defined(OSS_TOED_JSON)
/*****************************************************************************/
/*  TOED XER section                                                         */
/*****************************************************************************/
    /*************************************************************************/
...
extern void DLL_ENTRY _oss_jenc_enum(OssGlobal *g, _oss_enumInfo *_vN, int value);
...
extern short DLL_ENTRY _oss_jdec_fidx(_Json_Dec_Env *env,
		    struct _string_search_data * data);
...
extern int DLL_ENTRY _oss_jdec_enum(_Json_Dec_Env * env,
		    struct _string_search_data * data);
...
extern unsigned short DLL_ENTRY _oss_jdec_oid_encoded(_Json_Dec_Env *env,
				void *value, long size);
extern int DLL_ENTRY _oss_jdec_wrapped(_Json_Dec_Env *env, char *name);
...
#endif /* !SHIPPING || LED_SOURCECODE_SHIPPING */
typedef unsigned short Etag;
typedef struct efield *_oss_qWq;
typedef struct etype *_oss_jWq;
...
struct etype {
    ...
    size_t          _oss_Hjq;
    size_t          _oss_jWJJ;
    unsigned short int _oss_JHJJ;
    unsigned short int _oss_QqJJ;
    unsigned short int _oss_QqQJ;
    unsigned short int _oss_WQQJ;
    int                _oss_qHj;	    
    unsigned short int _oss_QWq;
};
struct efield {
    size_t          _oss_Qjq;	
    unsigned short int _oss_Jwj;	
    short int       _oss_wqQJ;	
    unsigned short int _oss_qJJJ;	
...
struct InnerSubtypeEntry {
    ...
    unsigned short	_oss_jqj;	     
    unsigned short	_oss_WWq;  
};
#if defined(SOED_SOURCECODE_SHIPPING)
#endif /* !SHIPPING || LED_SOURCECODE_SHIPPING */
struct eValRef {
...
typedef struct eda_table {
    unsigned int _oss_wjq;
    unsigned char *_oss_jJj;
} eda_table;
typedef struct midRelation {
    unsigned short _oss_QWQJ;
    unsigned short _oss_jjJJ;
    unsigned short _oss_HWQJ;
    unsigned short _oss_qQQJ;
} MidRelation;
struct eheader {
    void (DLL_ENTRY_FPTR *_System _oss_JwQJ)(struct ossGlobal *); 
    long            pdudecoder;	
    unsigned short int _oss_wjq;	
    ...
    struct ConstraintEntry *_oss_QWq;
    struct InnerSubtypeEntry *_oss_wWQJ;	
    void           *_oss_qHJJ;	
    unsigned short int _oss_JqJJ; 
    void           *_oss_jQQJ;
    unsigned short  _oss_JHQJ;
};
...
typedef struct {
    unsigned char *_oss_jqHJ;	    
    unsigned char *_oss_jHwJ;    
    unsigned char *_oss_qJwJ;	    
    unsigned char *_oss_HqjJ;	    
    void *_oss_wqHJ;	    
    void *_oss_wQwJ;	    
    OSS_UINT16 _oss_JqjJ;   
    OSS_UINT16 _oss_wQjJ;       
    OSS_UINT16 *_oss_qwwJ;        
} exer_extra_data;
typedef struct {
    OSS_INT32 _oss_JJHJ;	
    void ** _oss_JQjJ;	
...
typedef struct {
    OSS_UINT32 _oss_JjjJ;
    OSS_UINT32 _oss_qJjJ;
    unsigned char *_oss_HqJJ;	    
    OSS_UINT16 _oss_HWwJ;		    
    void *_oss_WQjJ;		    
    exer_extra_data *_oss_WWjJ;    
    exer_ext _oss_qQjJ;	    
} exer_type;
...
typedef struct {
    OSS_UINT32 _oss_qHWW;	    
    OSS_UINT16 *_oss_HHJW;    
} exer_union_data;
typedef struct {
    OSS_UINT16 _oss_wWqJ;		
    OSS_UINT16 _oss_wJWW;	
    OSS_UINT32 _oss_jwQW;	
    OSS_UINT32 *_oss_qqQW;		
} exer_order_data;
typedef struct {
    exer_tag_decoder *_oss_HwqJ; 
    exer_decode_position _oss_qJQW;   
} exer_set_data;
typedef struct {
    exer_tag_decoder *_oss_HwqJ; 
    exer_decode_position *_oss_wQJW; 
} exer_sequence_data;
...
PUBLIC void DLL_ENTRY ossLinkEJson (OssGlobal *, unsigned short,
					int const *, ossJSONencodefp *);
PUBLIC void DLL_ENTRY ossLinkDJson (OssGlobal *, unsigned short,
					int const *, ossJSONdecodefp *);

PUBLIC void DLL_ENTRY ossLinkJsonReal(OssGlobal *);
...
#endif /* (defined(OSS_SOED_JSON) || !defined(SHIPPING)) */
