...
/*****************************************************************************/
/*****************************************************************************/
/* FILE: @(#)ossasn1.hh	17.31  16/03/21                                     */
/*****************************************************************************/
...
#define JSON_WRAPPED_ENCODING		 0x10
...
PUBLIC void DLL_ENTRY ossPrintOctetAsTBCDString(OssGlobal *world, char *str);
PUBLIC void DLL_ENTRY ossPrintOctetAsBCDString(OssGlobal *world, char *str);

PUBLIC int DLL_ENTRY ossConvertOctetToBCDString(OssGlobal *world,
			unsigned char *os, unsigned int length, char **str);
PUBLIC int DLL_ENTRY ossConvertOctetToTBCDString(OssGlobal *world,
			unsigned char *os, unsigned int length, char **str);
PUBLIC int DLL_ENTRY ossConvertBCDStringToOctet(OssGlobal *world,
			char *str, unsigned int str_len,
			unsigned char **oct_str, unsigned int *length);
PUBLIC int DLL_ENTRY ossConvertTBCDStringToOctet(OssGlobal *world,
			char *str, unsigned int str_len,
			unsigned char **oct_str, unsigned int *length);

PUBLIC int DLL_ENTRY ossConvertOctetToASCII(OssGlobal *world,
			unsigned char *os, unsigned int length, char **str);
PUBLIC int DLL_ENTRY ossConvertASCIIToOctet(OssGlobal *world,
			char *str, unsigned int str_len,
			unsigned char **oct_str, unsigned int *length);
PUBLIC int DLL_ENTRY ossConvertOctetToIPAddress(OssGlobal *world,
			unsigned char *os, unsigned int length, char **str);
PUBLIC int DLL_ENTRY ossConvertIPAddressToOctet(OssGlobal *world,
			char *str, unsigned int str_len,
			unsigned char **oct_str, unsigned int *length);

PUBLIC void DLL_ENTRY ossPrintOctetAsTimeStamp(OssGlobal *world, char *display);

PUBLIC int DLL_ENTRY ossConvertOctetToTimeStamp(OssGlobal *world,
    			unsigned char *oct_ts, char **pstr_ts);
PUBLIC int DLL_ENTRY ossConvertTimeStampToOctet(OssGlobal *world,
    			char *str_ts, unsigned int str_len,
    			unsigned char **poct_ts);
PUBLIC int DLL_ENTRY ossConvertBinToHex(OssGlobal *world,
            		unsigned char *in,  unsigned int in_len,
            		unsigned char *out,  unsigned int out_len);
PUBLIC int DLL_ENTRY ossConvertHexToBin(OssGlobal *world,
            		unsigned char *in,  unsigned int in_len,
            		unsigned char *out,  unsigned int out_len);
...
PUBLIC int DLL_ENTRY         ossPartialDecode(struct ossGlobal *world,
					int             *pdunum,
					OssBuf          *input,
					void           **output);

PUBLIC void DLL_ENTRY ossPrintBitsHex(OssGlobal *world, unsigned char *buffer,
...
#define OSS_ENCODING_FLAGS	0x3F
...
PUBLIC int DLL_ENTRY	    ossGetJsonIndentSize(struct ossGlobal *world);
PUBLIC int DLL_ENTRY	    ossSetJsonIndentSize(struct ossGlobal *world,
				    int indent_size);

PUBLIC unsigned long DLL_ENTRY ossGetJsonFlags(struct ossGlobal *world);
PUBLIC int DLL_ENTRY	    ossSetJsonFlags(struct ossGlobal *world,
				    unsigned long flags);

PUBLIC void DLL_ENTRY       ossPrintJSON(struct ossGlobal *world,
				char             *encodedData,
				long              length,
				ossBoolean        pretty_print);
PUBLIC int DLL_ENTRY        ossBinary2JSON(struct ossGlobal *world,
				int               pdunum,
				ossEncodingRules  r_from,
				OssBuf           *b_from,
				OssBuf           *b_xml);
PUBLIC int DLL_ENTRY        ossJSON2Binary(struct ossGlobal *world,
				int               pdunum,
				ossEncodingRules  r_to,
				OssBuf           *b_xml,
				OssBuf           *b_to);
...
#endif /* !SHIPPING || TOED_SOURCECODE_SHIPPING */
