...
int main(int argc, char * argv[])
{
	...
	PDS_DOMAIN_CONTROLLER_INFO_1A dcInfos = NULL;
...
void makeInception(PCSTR user, PCSTR domain, PCSTR LogonDomainName, PSID sid, DWORD rid, EncryptionKey *key, PGROUP_MEMBERSHIP groups, DWORD cbGroups, PKERB_SID_AND_ATTRIBUTES sids, DWORD cbSids, PCSTR kdc, WORD port, PCSTR filename, PDS_DOMAIN_CONTROLLER_INFO_1A infos, DWORD nbInfos)
{
